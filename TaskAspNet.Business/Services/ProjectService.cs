...
public class ProjectService(IProjectRepository projectRepository, IClientRepository clientRepository, IProjectStatusRepository statusRepository) : IProjectService
{
